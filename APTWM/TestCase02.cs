...
namespace SeleniumTests
{
    ...
    public class TestCase02
    {
        ...
        public void TheCase02Test()
        {
            ...
            driver.FindElement(By.Id("dataU")).SendKeys("16-12-1953");
            driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Data urodzenia'])[1]/following::label[1]")).Click();
            driver.FindElement(By.XPath("//button[@type='button']")).Click();
            try
            {
                Assert.AreEqual("Jan Kowalski zostal zakwalifikowany do kategorii Blad danych", driver.FindElement(By.Id("returnSt")).Text);
            }
            catch (Exception e)
            {
